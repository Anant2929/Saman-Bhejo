  ...
  return (
    <div className="flex flex-col h-screen p-4">
      ...
      <div className="flex flex-col items-center justify-center flex-grow text-center mb-24">
        <h1
          className={`montserrat-regular text-[#ffffff] text-4xl font-bold mb-6 whitespace-nowrap overflow-hidden border-r-4 border-white animate-typewriter`}
        >
          Making Journeys Meaningful.
        </h1>
        <p
          className={`montserrat-regular text-[#d1cece] text-base md:text-lg text-justify mx-4`}
        >
